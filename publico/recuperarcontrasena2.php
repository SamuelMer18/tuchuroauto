    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                <div class="mb-3"><label class="form-label" for="password">Contraseña Nueva</label>
                    <input class="form-control" type="password" id="contra" name="contra">
                </div>
                <div class="mb-3">
                    <button class="btn btn-primary" type="submit" name="cambiarcontra">Cambiar Contraseña</button>
                </div>
                <?php
